...
Products have varying attributes -- color, size, material -- that don't warrant
...
Store user settings -- timezone, language, notification preferences -- as
...
+-----------------------------------+----------+--------+
| Scenario                          | HStore   | JSONB  |
+-----------------------------------+----------+--------+
| Product attributes                | Yes      |        |
+-----------------------------------+----------+--------+
| User preferences                  | Yes      |        |
+-----------------------------------+----------+--------+
| Content tags / metadata           | Yes      |        |
+-----------------------------------+----------+--------+
| Nested app configuration          |          | Yes    |
+-----------------------------------+----------+--------+
| API response caching              |          | Yes    |
+-----------------------------------+----------+--------+
| Mixed-type form data              |          | Yes    |
+-----------------------------------+----------+--------+
| Document storage                  |          | Yes    |
+-----------------------------------+----------+--------+

When in doubt, start with HStore. It's simpler, more compact, and gives you a
better admin experience. Migrate to JSONB only when you genuinely need nested
structures or mixed value types.
